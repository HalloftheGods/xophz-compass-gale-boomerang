 ...
 * Update URI:        https://github.com/HalloftheGods/xophz-compass-gale-boomerang
 */
 ...
 */
define( 'XOPHZ_COMPASS_GALE_BOOMERANG_VERSION', '26.9.21-629' );
...
function deactivate_xophz_compass_gale_boomerang() {
	Xophz_Compass_Gale_Boomerang::deactivate();
}
...
add_action( 'plugins_loaded', 'run_xophz_compass_gale_boomerang' );
